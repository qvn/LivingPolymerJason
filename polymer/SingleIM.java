...
public class SingleIM {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		//Get initial Values
		//Io,Mo,sc,ki,kp
	    Io = SingleIM.getDoubleFromShell("Io: ");
	    Mo = SingleIM.getDoubleFromShell("Mo: ");
	    ki = SingleIM.getDoubleFromShell("ki: ");
	    kp = SingleIM.getDoubleFromShell("kp: ");	   
	    String FileName = SingleIM.getStringFromShell("File Name As: ");
		sc=0.0005;
		r=kp/ki;
		R=Math.abs(1-r);
