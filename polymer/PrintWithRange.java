...
//Looking for Ri
	...
	double dx = b-a;   
	    ...
	    dt = PrintWithRange.getDoubleFromShell("dt (default of 0.0005): ");
	    //int FileType = StandAlone.getIntFromShell("File Type As: (1) SpaceDlim (2) Matlab: ");
	    int FileType=1;
	    if (FileType==2){FileName = PrintWithRange.getStringFromShell("File Name As: ");}
	    ...
	    int Ans = PrintWithRange.getIntFromShell("Number of pts will be "+TimeTotal/dt+" - Use it? (1=Y/2=N)"); 
